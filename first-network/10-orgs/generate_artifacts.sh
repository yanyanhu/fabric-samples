...
function replacePrivateKey () {
  ...
  cd crypto-config/peerOrganizations/org9.example.com/ca/
  PRIV_KEY=$(ls *_sk)
  cd "$CURRENT_DIR"
  sed $OPTS "s/CA9_PRIVATE_KEY/${PRIV_KEY}/g" docker-compose-e2e.yaml

  cd crypto-config/peerOrganizations/org10.example.com/ca/
  PRIV_KEY=$(ls *_sk)
  cd "$CURRENT_DIR"
  sed $OPTS "s/CA10_PRIVATE_KEY/${PRIV_KEY}/g" docker-compose-e2e.yaml
